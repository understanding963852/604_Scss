...
-------------------------------------
# 🚒  변수만들기
# scss에서 변수 --> $로 시작한다(영문, 숫자, -, _)만 사용할수 있다, (※숫자로 시작하면 안됨)


# 🍰 인터폴레이션방법  --  보간법: 변수나 표현식을 문자열 내에 삽입하는 기능을 의미
![image](https://github.com/understanding963852/604_Scss/assets/60366769/84d74dcc-679f-49c5-87cb-1cf8618c3267)
